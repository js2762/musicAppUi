...
class MusicController extends GetxController {
  ...
  Future<void> extractMusicInfo() async {
    ByteData assetData = await rootBundle.load('assets/musics/king.mp3');
    Directory tempDir = await Directory.systemTemp.createTemp();
    String tempFilePath = '${tempDir.path}/king.mp3';
  ...
  void back10Sec(){
    final newPosition = Duration(seconds: (currentPosition.value.inSeconds - 10).toInt());
