            ...
            () {
              return RichText(
                ...
                text:  TextSpan(
                  children: [
                    TextSpan(
                      text: (musicController.songName.value == 'null' || musicController.songName.value == '') ? "unknown\n" : "${musicController.songName}\n",
                      style: TextStyle(
                        fontSize: 22,
                   ...
                   const WidgetSpan(
                    ...
                    TextSpan(
                      text: (musicController.albumName.value == 'null' || musicController.albumName.value == '') ? "unknown\n" : "${musicController.albumName}",
                ...
                child: Obx(
                  () {
                    return Slider(
                      ...
                      value: musicController.currentPosition.value.inSeconds.toDouble(),
                      min: 0,
                      max: musicController.audioDuration.value.inSeconds.toDouble(),
                      onChanged: (value) {
            ...
            child: Obx(
              () {
                return Row(
                  ...
                  children: [
                    Text(
                      musicController.formatTime(musicController.currentPosition.value.inSeconds),
                      style: const TextStyle(color: Colors.grey),
                    ),
                    Text(
                      musicController.formatTime(musicController.audioDuration.value.inSeconds),
                      style: const TextStyle(color: Colors.grey),
                    ),
                  ],
                );
                            ...
                            child: Obx(
                              () {
                                return SvgPicture.asset(
                                 musicController.isPlaying.value ? AppImages.pauseIcon : AppImages.playIcon,
